export const CardData = [
    {
        cardName: "Jack the Sheep",
        cardType: "Polymorph",
        cardDesc: "This card can only be played by mages",
        cardText: "Transform any minion to a 1/1 sheep",
        cardFlav: "Baaaaaaaaa...",
        imgURL: "./PolymorphArt.jpg",
        cardAuth: "theHSIdiots"
    }, {
        cardName: "Jean-Luc Picard",
        cardType: "Captain",
        cardDesc: "Can only be used if Wesley Crusher is NOT in play",
